...
<body>
    <div class="card">
      ...
      <div id="message">
          <p><b>Hello,</p>
          <p>We are pleased to inform you that <?php echo $candidato; ?>'s process has been completed and it is possible to consult it on our <a href="https://rodicontrol.rodi.com.mx">RODICONTROL platform</a>.</p>
