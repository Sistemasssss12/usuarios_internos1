...
<body>
	  	...
	  	<tr>
			...
			?>
				<tr>
					...
					<td class="left" width="80%"><p class="f-11"><?php echo $checklist->prohibited_parties_list; ?></p></td>
				</tr>
			<?php 
			} ?>
	  	<tr>
	...
	<?php 
	if($id_proyecto == 27 || $id_proyecto == 28){ ?>
		<div class="div_datos">
	...
	if($docs){
		foreach($docs as $doc){
			if($doc->id_tipo_documento == 12){ ?>
				...
				<div class="center">
					<?php echo '<img src="'.base_url().'_docs/'.$doc->archivo.'" width="550" height="650"><br><br>'; ?>
				</div>
				<div class="div_datos">
	...
	if($docs){
		foreach($docs as $doc){
			if($doc->id_tipo_documento == 17){ ?>
				...
				<div class="center">
					<?php echo '<img src="'.base_url().'_docs/'.$doc->archivo.'" width="650" height="550"><br><br>'; ?>
				</div>
				<pagebreak>
	<?php
			}
