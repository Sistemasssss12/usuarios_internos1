...
<body>
	<?php
      ...
      if($credito_check == 0){ $f_credito_check = "fondo2"; $s_credito_check = "Negative"; }
			if($credito_check == 1){ $f_credito_check = "fondo1"; $s_credito_check = "Positive"; }
			if($credito_check == 2){ $f_credito_check = "fondo3"; $s_credito_check = "FC"; }
			if($credito_check == 3){ $s_credito_check = "NA"; }
      ...
      //Se extrae la fecha de la creacion del historial de credito
			...
			$estudios = $this->funciones_model->getGradoEstudioById($id_grado_estudio);
	...
	<div class="flotar-izquierda w-70">
		<table class="w-90">
          ...
          if($secciones->lleva_estudios == 1){
		    		$fecha_estudios = $fecha_ver_estudios; ?>
          ...
          <?php  
		  	...
		  	<tr>
		    	...
		    	<td class="NA"><p class="f-14">NA</p></td>
		    	<td>NA</td>
		  	</tr>	
        <tr>
		  		<td class="left">Credit Bureau check</td>
		    	<td class="<?php echo $f_credito_check; ?>"><p class="f-14"><?php echo $s_credito_check; ?></p></td>
    ...
    <div class="div_datos">
      ...
      <table class="">
          ...
          <tr>
            ...
            <?php $tel_casa = (!empty($telefono_casa))? $telefono_casa : 'Not provided'; ?>
            <td class="center"><p class="f-12"><?php echo $tel_casa; ?></p></td>
          </tr>
          <tr>
            <td class="encabezado">Another Number Phone:</td>
            <?php $tel_otro = (!empty($telefono_otro))? $telefono_otro : 'Not provided'; ?>
  ...
  <?php 
	...
	<?php 
	if($secciones->lleva_estudios == 1 && !empty($ver_mayor_estudio)){
    if($liberado == 1){ ?>
      <div class="div_datos">
        ...
        <table class="">
          <tr>
            ...
            <tr>
              ...
              <td class="center"><p class="f-12"><?php echo $estudios->nombre_ingles; ?></p></td>
  ...
  <?php 
	...
	if($docs){
        ...
        echo '<div class="center sin-flotar margen-top"><p class="f-20">VALIDATED Database Check</p></div>';
        echo '<div class="center">';
        echo '<img src="'.base_url().'_docs/'.$doc->archivo.'" ><br><br>';
        echo '</div>';
        echo '<pagebreak>';
			}
      if($doc->id_tipo_documento == 25){
        echo '<div class="center sin-flotar margen-top"><p class="f-20">VALIDATED Criminal Records</p></div>';
        echo '<div class="center">';
        echo '<img src="'.base_url().'_docs/'.$doc->archivo.'" ><br><br>';
        echo '</div>';
        echo '<pagebreak>';
    ...
    foreach($docs as $doc){
        ...
        echo '<div class="center sin-flotar margen-top"><p class="f-20">Credit Bureau</p></div>';
        echo '<div class="center">';
        echo '<img src="'.base_url().'_docs/'.$doc->archivo.'" ><br><br>';
        echo '</div>';
        echo '<pagebreak>';
