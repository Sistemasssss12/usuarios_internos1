...
<body>
	...
	*/
	...
	<div class="flotar-izquierda w-70">
		<table class="w-90">
		  	...
		  	<tr>
		    	...
		    	<td class="<?php //$f_empleo; ?>"><p class="f-14"><?php echo 'NA';//$s_empleo; ?></p></td>
		    	<td><?php echo 'NA';//$fecha_final; ?></td>
		  	</tr>
		  	<tr>
		  		<td class="left">Academic History check</td>
		    	<td class="<?php //$f_estudios; ?>"><p class="f-14"><?php echo 'NA';//$s_estudios; ?></p></td>
		    	<td><?php echo 'NA';//$fecha_ver_estudios; ?></td>
		  	</tr>
		  	<tr>
		  		<td class="left">Home Visit (If Applicable)</td>
		    	<td class="<?php //$f_visita; ?>"><p class="f-14"><?php echo 'NA';//$s_visita; ?></p></td>
		    	<td>NA</td>
		  	</tr>
		  	<tr>
		  	...
		  	<tr>
		    	...
		    	<td class=""><p class="f-14"><?php echo 'NA';//$s_medico; ?></p></td>
		    	<td>NA</td>
		  	</tr>	  	
		</table>	
	</div>
	...
	<?php 
	if($fecha_ver_penales != null && $det_penales != null){ ?>
		<div class="center sin-flotar margen-top">
			<p class="f-20">Criminal Records – Mexican </p>
		</div>
		<?php 
		if($docs){
