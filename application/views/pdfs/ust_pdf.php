...
<body>
	<?php
      ...
      if($global == 0){ $f_global = "fondo2"; $s_global = "Negative"; }
			...
			if($global == 2){ $f_global = "fondo3"; $s_global = "Under Revision"; }
			if($global == 3){ $f_global = "fondo0"; $s_global = "NA"; }
	...
	*/
	...
	<div class="col-md-6">
		<table class="media-tabla">
		  	...
		  	<tr>
		  		<td>Home Visit (If Applicable)</td>
		  	...
		  	<tr>
		  		<td>Laboratory Test (If Applicable)</td>
		    	<td class="<?php echo $f_lab; ?>"><p class="f-14"><?php echo $s_lab; ?></p></td>
		    	<td>NA</td>
		  	</tr>
		  	<tr>
		  		<td>Medical Check Up (If Applicable)</td>
	...
	<div class="center sin-flotar margen-top">
		<p class="f-20"><?php echo $pagina++; ?>. VALIDATED Criminal Records </p>
	</div>
	<?php 
	if($docs){
  ...
  <?php 
	...
	<!-- HOJA 8 -->
	<div class="center sin-flotar margen-top">
		<p class="f-20"><?php echo $pagina++; ?>. VALIDATED Criminal Records – OFAC</p>
	</div>
	<?php 
	if($docs){
		echo '<div class="center">';
