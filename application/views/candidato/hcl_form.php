...
<head>
	...
	<?php 
	$avisoPrivacidad = ($info->id_cliente == 2) ? 'non-disclosure-hcl.pdf' : 'non-disclosure.pdf';
	if($parametros->lleva_domicilios == 1){ ?>
	<script>
		function buscarMunicipioHistorial(id_estado, id_municipio, i){
			$.ajax({
				...
				success: function(res) {
					$('#h'+i+'_estado').val(id_estado);
					$('#h'+i+'_municipio').html(res);
					$('#h'+i+'_municipio').val(id_municipio);
				}
			});
		}
	</script>
...
<body>
						...
						<div class="row">
							<div class="col-sm-12 col-md-3 col-lg-3">
								...
								<div class="input-group mb-3">
									...
									<input type="text" class="form-control obligado" name="calle" id="calle" value="<?php echo $info->calle; ?>">
								</div>
							</div>
							<div class="col-sm-12 col-md-3 col-lg-3">
								...
								<div class="input-group mb-3">
									...
									<input type="text" class="form-control obligado" name="exterior" id="exterior" maxlength="8" value="<?php echo $info->exterior; ?>">
								</div>
							</div>
							<div class="col-sm-12 col-md-3 col-lg-3">
								...
								<div class="input-group mb-3">
									...
									<input type="text" class="form-control" name="interior" id="interior" maxlength="8" value="<?php echo $info->interior; ?>">
								</div>
							</div>
							<div class="col-sm-12 col-md-3 col-lg-3">
								...
								<div class="input-group mb-3">
									...
									<input type="text" class="form-control obligado" name="colonia" id="colonia" value="<?php echo $info->colonia; ?>">
								</div>
							</div>
						</div>
						<br>
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 col-lg-3">
								...
								<div class="input-group mb-3">
									...
									<input type="text" class="form-control solo_numeros obligado" name="cp" id="cp" maxlength="5" value="<?php echo $info->cp; ?>">
								</div>
							</div>
              <div class="col-sm-12 col-md-3 col-lg-3">
								<label>CURP *</label>
                  ...
                  <input type="text" class="form-control " name="curp_general" id="curp_general" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" maxlength="18" value="<?php echo $info->curp; ?>">
								</div>
							</div>
						</div>
					</div>
      ...
      if($parametros->lleva_domicilios == 1){ ?>
        <div class="accordion" id="acordeonCollapse">
          <div class="card my-5">
            ...
            <div class="card-body">
              <h6 class="alert alert-warning card-subtitle mb-2 text-muted text-center">TYPE IN YOUR ADDRESSES OF THE LAST SEVEN YEARS, STARTING WITH THE CURRENT ONE</h6>
              <div class="card my-5">
              <?php 
              for($i = 1;$i<=15;$i++){
								if($doms != false){
									if((isset($doms[$i-1]->id_estado))){
										echo '<script> buscarMunicipioHistorial('.$doms[$i-1]->id_estado.','.$doms[$i-1]->id_municipio.','.$i.') </script>';
									}
									$per = (isset($doms[$i-1]->periodo))? $doms[$i-1]->periodo : '';
									$cau = (isset($doms[$i-1]->causa))? $doms[$i-1]->causa : '';
									$cal = (isset($doms[$i-1]->calle))? $doms[$i-1]->calle : '';
									$ext = (isset($doms[$i-1]->exterior))? $doms[$i-1]->exterior : '';
									$int = (isset($doms[$i-1]->interior))? $doms[$i-1]->interior : '';
									$col = (isset($doms[$i-1]->colonia))? $doms[$i-1]->colonia : '';
									$cp = (isset($doms[$i-1]->cp))? $doms[$i-1]->cp : '';
								}
								else{
									$per = '';$cau = '';$cal = '';$ext = '';$int = '';$col = '';$cp = '';
								}
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-md-2 col-lg-2">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" name="h<?php echo $i; ?>_calle" id="h<?php echo $i; ?>_calle" value="<?php echo $cal; ?>">
                        </div>
                      </div>
                      <div class="col-sm-12 col-md-2 col-lg-2">
                        <label>Exterior Number *</label>
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" name="h<?php echo $i; ?>_exterior" id="h<?php echo $i; ?>_exterior"  maxlength="8"  value="<?php echo $ext; ?>">
                        </div>
                      </div>
                    </div>
                    <br>
                    <div class="row">
                      <div class="col-sm-12 col-md-4 col-lg-4">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" name="h<?php echo $i; ?>_interior" id="h<?php echo $i; ?>_interior" maxlength="8"  value="<?php echo $int; ?>">
                        </div>
                      </div>
                      <div class="col-sm-12 col-md-4 col-lg-4">
                        <label>Neighborhood *</label>
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" name="h<?php echo $i; ?>_colonia" id="h<?php echo $i; ?>_colonia"  value="<?php echo $col; ?>">
                        </div>
                      </div>
                      <div class="col-sm-12 col-md-4 col-lg-4">
                        <label>State *</label>
                        <div class="input-group mb-3">
                          ...
                          <select name="h<?php echo $i; ?>_estado" id="h<?php echo $i; ?>_estado" class="form-control es_estado">
                            <option value="">Select</option>
                            <?php foreach ($estados as $e) {?>
                                <option value="<?php echo $e->id; ?>"><?php echo $e->nombre; ?></option>
                            <?php } ?>
                    ...
                    <div class="row">
                      <div class="col-sm-12 col-md-4 col-lg-4">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <select name="h<?php echo $i; ?>_municipio" id="h<?php echo $i; ?>_municipio" class="form-control">
                            <option value="">Select</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-sm-12 col-md-4 col-lg-4">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control solo_numeros" name="h<?php echo $i; ?>_cp" id="h<?php echo $i; ?>_cp" maxlength="5"  value="<?php echo $cp; ?>">
                        </div>
                      </div>
                    </div>
                  </div>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					foreach($docs_requeridos as $requerido){
						if($requerido->solicitado == 1 && $requerido->id_tipo_documento != 12){
					?>
	...
	<script>
		...
		var form_estado = "<?php echo $info->id_estado; ?>";
		$('#estado').val(form_estado);
		if(form_estado != ''){
			var form_municipio = "<?php echo $info->id_municipio; ?>";
			buscarMunicipio(form_estado,form_municipio);
		}
      ...
      $(".es_estado").change(function() {
				var estado = $(this).val();
        var idEstado = $(this).attr('id');
        var parte = idEstado.split('_');
        var municipio = parte[0]+'_municipio';
				if (estado != '') {
					$.ajax({
						url: '<?php echo base_url('Funciones/getMunicipios'); ?>',
						method: 'POST',
			...
			$("#estado").change(function() {
				...
				if (id_estado != '') {
					$.ajax({
						...
						success: function(res) {
              $('#h1_estado').val(id_estado);
							$('#municipio').prop('disabled', false);
							$('#municipio').html(res);
              $('#h1_municipio').html(res);
						}
					});
				} else {
					$('#municipio').prop('disabled', true);
					$('#municipio').append($("<option selected></option>").attr("value", '').text("Select"));
          $('#h1_estado').append($("<option selected></option>").attr("value",'').text("Select"));
          $('#h1_municipio').empty();
          $('#h1_municipio').append($("<option selected></option>").attr("value",'').text("Select"));
				}
			});
      $("#municipio").change(function() {
				var id_municipio = $(this).val();
				if (id_municipio != '') {
					$('#h1_municipio').val(id_municipio);
				} else {
          $('#h1_municipio').empty();
          $('#h1_municipio').append($("<option selected></option>").attr("value",'').text("Select"));
				}
      ...
      $("#calle").change(function(){
	    ...
	    $("#exterior").change(function(){
	    	var valor = $(this).val();
	    	$("#h1_exterior").val(valor);
	    });
	    $("#interior").change(function(){
	    	var valor = $(this).val();
	    	$("#h1_interior").val(valor);
	    });
	    $("#colonia").change(function(){
	    	var valor = $(this).val();
	    	$("#h1_colonia").val(valor);
	    });
	    $("#cp").change(function(){
	    	var valor = $(this).val();
	    	$("#h1_cp").val(valor);
			...
			$('#subirFormulario').click(function() {
				...
				data.append('curp', $('#curp_general').val());
        ...
        for (var j = 1; j <= 15; j++) {
					...
					data.append('h' + j + 'calle', $('#h' + j + '_calle').val());
					data.append('h' + j + 'exterior', $('#h' + j + '_exterior').val());
					data.append('h' + j + 'interior', $('#h' + j + '_interior').val());
					data.append('h' + j + 'estado', $('#h' + j + '_estado').val());
					data.append('h' + j + 'municipio', $('#h' + j + '_municipio').val());
					data.append('h' + j + 'colonia', $('#h' + j + '_colonia').val());
					data.append('h' + j + 'cp', $('#h' + j + '_cp').val());
				}
				...
				$.ajax({
					url: "<?php echo base_url('Candidato/guardarFormHCLCandidato'); ?>",
					type: 'POST',
					data: data,
					contentType: false,
					cache: false,
		...
		function buscarMunicipio(id_estado, id_municipio){
			$.ajax({
				url: '<?php echo base_url('Funciones/getMunicipios'); ?>',
				method: 'POST',
				data: {
